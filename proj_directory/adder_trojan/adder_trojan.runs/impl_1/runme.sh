...
HD_PWD='D:/Aghilan/Amrita/Project_phase_2/proj_directory/adder_trojan/adder_trojan.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_level_adder_actor.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_level_adder_actor.tcl -notrace
