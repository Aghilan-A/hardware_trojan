...
HD_PWD='D:/Aghilan/Amrita/Project_phase_2/proj_directory/adder_trojan/adder_trojan.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_level_adder_actor.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_level_adder_actor.tcl
