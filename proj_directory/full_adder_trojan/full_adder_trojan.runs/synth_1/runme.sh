...
HD_PWD='D:/Aghilan/Amrita/Project_phase_2/proj_directory/full_adder_trojan/full_adder_trojan.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fa_trojan.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fa_trojan.tcl
