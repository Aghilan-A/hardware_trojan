...
HD_PWD='D:/Aghilan/Amrita/Project_phase_2/proj_directory/full_adder_trojan/full_adder_trojan.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log fa_trojan.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source fa_trojan.tcl -notrace
