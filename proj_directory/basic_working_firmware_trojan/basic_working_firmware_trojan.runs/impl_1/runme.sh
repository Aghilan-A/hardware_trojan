...
HD_PWD='D:/Aghilan/Amrita/Project_phase_2/proj_directory/basic_working_firmware_trojan/basic_working_firmware_trojan.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log trojan_design_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source trojan_design_wrapper.tcl -notrace
