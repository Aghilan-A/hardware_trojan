...
HD_PWD='D:/Aghilan/Amrita/Project_phase_2/proj_directory/basic_working_firmware_trojan/basic_working_firmware_trojan.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log trojan_design_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source trojan_design_wrapper.tcl
